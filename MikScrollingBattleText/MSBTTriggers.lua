...
local function HandleHealthAndPowerTriggers(unit, event, currentAmount, maxAmount, powerType)
	...
	-- Retail 12.x safety: UnitHealth/UnitPower can be nil or "secret" numbers; sanitize via tostring->tonumber.
	currentAmount = tonumber(tostring(currentAmount))
	maxAmount = tonumber(tostring(maxAmount))
