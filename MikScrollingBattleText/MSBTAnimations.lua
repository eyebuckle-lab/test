...
-- Retail 12.x safety: ensure API is available even if MSBTMain hasn't run yet.
if _G.MikSBT and not _G.MikSBT.DisplayMessage then
	_G.MikSBT.DisplayMessage = DisplayMessage
end
